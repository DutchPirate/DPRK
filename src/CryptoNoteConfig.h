...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       =0xa5c; // address starts with "dp"
...
const char     CRYPTONOTE_NAME[]                             = "DPRK";
...
const int      P2P_DEFAULT_PORT                              =63333  ;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              =63334  ;
